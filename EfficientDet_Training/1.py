...
input_file = '../Near_Drowning_Repository/Yet-Another-EfficientDet-Pytorch/datasets/Near_Drowning_Detector-8/annotations/instances_train2017.json'
output_file = '../Near_Drowning_Repository/Yet-Another-EfficientDet-Pytorch/datasets/Near_Drowning_Detector-8/annotations/fixed_instances_train2017.json'
